...
function App() {
  ...
  return (
    <div className='protocol-mobile-container'>
      <div className='protocol-mobile-header' onClick={goToHome}><img src={require("../../assets/logo.png")} alt=""/></div>
      <div>
        <p className='protocol-mobile-title'>免责声明</p>
        <div className='protocol-mobile-content'>
