...
from users.admin.views import (
    AdminFeedbackViewSet, AdminLoginViewSet, AdminSummaryViewSet, AdminUserViewSet,
    ConfigViewSet
)
...
router.register(r'feedback', AdminFeedbackViewSet, basename='AdminFeedbackViewSet')
